...
const HeroSection = () => (
  <section className="relative min-h-[100vh] sm:h-[80vh] sm:min-h-[600px] overflow-hidden">
    ...
    <div className="absolute inset-0">
      ...
      <div 
        className="absolute inset-0 bg-[url('/Other%20images/wmremove-transformed.webp')] bg-cover bg-center"
...
const EdificioPhotoEssay = () => {
  ...
  const photos = [
    { id: 1, alt: 'Design Competition', gradient: 'from-[#0b3d91] to-blue-600', icon: <Rocket className="h-20 w-20" />, src: '/images/edificio/design-competition.jpg' },
